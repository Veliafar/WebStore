    ...
    public static class TestData
    {
        ...
        public static IEnumerable<Section> Sections { get; } = new[]
        {
            ...
            new Section {Id = 7, Name = "Для Мужчин", Order = 1},
                new Section {Id = 8, Name = "Fendi man", Order = 0, ParentId = 7},
                new Section {Id = 9, Name = "Guess man", Order = 1, ParentId = 7},
                new Section {Id = 10, Name = "Valentino man", Order = 2, ParentId = 7},
        ...
        public static IEnumerable<Product> Products { get; } = new[]
        {
            ...
            new Product {Id = 5, Name = "Дегкая майка", Price = 1025, ImageUrl="product5.jpg", Order=4, SectionId = 2,BrandId = 2},
            new Product {Id = 6, Name = "Легкое голубое поло", Price = 1025, ImageUrl="product6.jpg", Order=5, SectionId = 2,BrandId = 2},
            new Product {Id = 7, Name = "Платье белое", Price = 1025, ImageUrl="product7.jpg", Order=6, SectionId = 2,BrandId = 2},
            new Product {Id = 8, Name = "Костюм кролика", Price = 1025, ImageUrl="product8.jpg", Order=7, SectionId = 25,BrandId = 2},
            new Product {Id = 9, Name = "Красное китайское платье", Price = 1025, ImageUrl="product9.jpg", Order=8, SectionId = 25,BrandId = 3},
